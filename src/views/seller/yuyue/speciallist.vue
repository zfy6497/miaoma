...
<template>
    <list :show-search="true" :show-date="false" :show-key-word="true" :show-add-button="false" :show-page="true" :update-url="updateUrl"
        :delete-url="deleteUrl" :add-url="addUrl" :get-url="getUrl" :submitbtn="false" :form-custom="formCustom" :rule-custom="ruleCustom" :modal-Width="500" @set-form="setForm" :other-query="otherQuery">
        <template slot="fromtop">
          <div class="ivu-modal-header"><div class="ivu-modal-header-inner">专家信息</div></div>
        </template>
...
export default {
  ...
  data() {
    return {
      ...
      deleteUrl: "",
      addUrl: "",
      getUrl: "api/StoreApi/GetSpecialList",
      TheirStores1: [],
      formCustom: {
        Id: 0,
        Name: "", //专家名称
