...
<template>
    <list :show-search="true" :show-date="false" :show-key-word="true" :show-add-button="true" :show-page="true" :update-url="updateUrl"
        ...
        <template slot="fromtop">
          <div class="ivu-modal-header"><div class="ivu-modal-header-inner">专家考评</div></div>
        </template>
...
export default {
  ...
  data() {
    return {
      updateUrl: "admin/Special/Appraisal/AddOrUpdate",
      deleteUrl: "admin/Special/Appraisal/Delete",
      addUrl: "admin/Special/Appraisal/AddOrUpdate",
      getUrl: "admin/Special/Appraisal",
      formCustom: {
        Id: 0,
        Title: "", //标题
        Content: "", //内容
