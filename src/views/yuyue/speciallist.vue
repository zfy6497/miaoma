    ...
    <div>
        <Card>
            ...
            <Row>
                ...
                <Modal :width="560" :scrollable="true" v-model="showAdd"  class-name="vertical-center-modal" title="专家管理">
                    <template>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      updateUrl: "api/Special/AddOrUpdate",
      deleteUrl: "api/Special/Delete",
      addUrl: "api/Special/AddOrUpdate",
      getUrl: "api/Special/GetList"
    };
  },
  methods: {
    getData() {
