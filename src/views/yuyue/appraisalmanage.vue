...
<template>
    <list :show-search="true" :show-date="true" :show-key-word="true" :show-add-button="false" :show-page="true" :update-url="updateUrl"
        :delete-url="deleteUrl" :add-url="addUrl" :routername="'appraisal_detail'"  :get-url="getUrl" :form-custom="formCustom" :rule-custom="ruleCustom" :modal-Width="500" @set-form="setForm" :other-query="otherQuery">
...
export default {
  ...
  data() {
    return {
      ...
      deleteUrl: "",
      addUrl: "",
      getUrl: "admin/Appraisal/GetList",
      formCustom: {
        Id: 0,
        Title: "", //标题
        Content: "", //内容
